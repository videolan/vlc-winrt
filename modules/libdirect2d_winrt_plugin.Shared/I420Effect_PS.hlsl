	...
	) : SV_Target
{
	...
	color.b = clamp(1.164383561643836*(Y.r - 16) + 2.017232142857142*(U.r - 128), 0, 255) / 255.0f;
	color.g = clamp(1.164383561643836*(Y.r - 16) - 0.812967647237771*(V.r - 128) - 0.391762290094914*(U.r - 128), 0, 255) / 255.0f;
	color.r = clamp(1.164383561643836*(Y.r - 16) + 1.596026785714286*(V.r - 128), 0, 255) / 255.0f;
