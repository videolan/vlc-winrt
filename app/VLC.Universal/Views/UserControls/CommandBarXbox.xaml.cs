...
namespace VLC.UI.Views.UserControls
{
    public sealed partial class CommandBarXbox : UserControl
    {
        ...
        private void CommandBarXbox_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Responsive();
            this.MiniPlayerVisibility = Locator.MediaPlaybackViewModel.MiniPlayerVisibility;
        ...
        {
            if (e.PropertyName == nameof(Locator.MediaPlaybackViewModel.MiniPlayerVisibility))
            {
                this.MiniPlayerVisibility = Locator.MediaPlaybackViewModel.MiniPlayerVisibility;
            }
        }
