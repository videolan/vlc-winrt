...
namespace VLC_WinRT.UI.Legacy.Views.UserControls
{
    public sealed partial class CommandBarBottom : CommandBar
    {
        ...
        {
            //if (e.PropertyName == nameof(Locator.MusicPlayerVM.Scrobble(IsMiniPlayerVisible))
            //{
        ...
        public void UpdatePlayerVisibility()
        {
            ...
            {
                if (DeviceHelper.GetDeviceType() != DeviceTypeEnum.Tablet )//|| //GetForCurrentView().UserInteractionMode == UserInteractionMode.Touch)
                {
        ...
        public void StopPlayback()
        {
            ...
            Locator.MediaPlaybackViewModel.PlaybackService.ClearPlaylist();
        }
    }
}
