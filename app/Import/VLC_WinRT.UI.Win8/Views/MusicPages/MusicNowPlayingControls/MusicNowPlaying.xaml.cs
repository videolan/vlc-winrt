...
namespace VLC_WinRT.Views.MusicPages.MusicNowPlayingControls
{
    public sealed partial class MusicNowPlaying : UserControl
    {
        ...
        private async void PlayPauseHold(object sender, HoldingRoutedEventArgs e)
        {
            ...
            await Locator.MediaPlaybackViewModel.ClearMediaTransportControls();/*.CleanViewModel();*/
        ...
        private void MusicNowPlaying_OnLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
                MusicNowPlayingFlipView.SelectedIndex = Locator.MediaPlaybackViewModel.AudioTracks.IndexOf(Locator.MediaPlaybackViewModel.CurrentAudioTrack);
                //Locator.MediaPlaybackViewModel..PropertyChanged += TrackCollectionOnPropertyChanged;
        ...
        {
            if (Locator.MediaPlaybackViewModel.CurrentAudioTrack == null) return;
