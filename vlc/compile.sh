...
${TARGET_TUPLE}-gcc -dumpspecs | sed -e 's/-lmingwex/-lmingwex -lwinstorecompat/' -e 's/-lmsvcrt/-lmsvcr110/' > ../newspecfile
...
echo "EXTRA_CFLAGS=-g -DNDEBUG ${EXTRA_CPPFLAGS}" >> config.mak
